...
import { setCredentials, clearCredentials, } from "@/redux/admin/auth/adminAuthSlice";
...
export var adminBaseQueryWithReauth = function (args, api, extraOptions) { return __awaiter(void 0, void 0, void 0, function () {
    var result, refreshResult, refreshData;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, baseQuery(args, api, extraOptions)];
            case 1:
                result = _a.sent();
                if (!(result.error && result.error.status === 401)) return [3 /*break*/, 5];
            ...
            case 2:
                ...
                if (!refreshResult.data) return [3 /*break*/, 4];
